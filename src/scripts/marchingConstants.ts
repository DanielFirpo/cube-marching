...
//credit https://gist.github.com/dwilliamson/c041e3454a713e58baf6e4f8e5fffecd
...
//convenient array to loop over corners of a cube
export const CORNER_ARRAY: Vector3[] = [
  new Vector3(0, 0, 0), //0
  new Vector3(1, 0, 0), //1
  new Vector3(0, 1, 0), //2
  new Vector3(1, 1, 0), //3
...
//A table which can be indexed with the edge index and returns the start and end point of that edge.
export const EDGE_ARRAY: Vector3[][] = [
  [new Vector3(0.0, 0.0, 0.0), new Vector3(1.0, 0.0, 0.0)],
  [new Vector3(1.0, 0.0, 0.0), new Vector3(1.0, 1.0, 0.0)],
  [new Vector3(0.0, 1.0, 0.0), new Vector3(1.0, 1.0, 0.0)],
  [new Vector3(0.0, 0.0, 0.0), new Vector3(0.0, 1.0, 0.0)],
  [new Vector3(0.0, 0.0, 1.0), new Vector3(1.0, 0.0, 1.0)],
  [new Vector3(1.0, 0.0, 1.0), new Vector3(1.0, 1.0, 1.0)],
  [new Vector3(0.0, 1.0, 1.0), new Vector3(1.0, 1.0, 1.0)],
  [new Vector3(0.0, 0.0, 1.0), new Vector3(0.0, 1.0, 1.0)],
  [new Vector3(0.0, 0.0, 0.0), new Vector3(0.0, 0.0, 1.0)],
  [new Vector3(1.0, 0.0, 0.0), new Vector3(1.0, 0.0, 1.0)],
  [new Vector3(1.0, 1.0, 0.0), new Vector3(1.0, 1.0, 1.0)],
  [new Vector3(0.0, 1.0, 0.0), new Vector3(0.0, 1.0, 1.0)],
];

// A table which can be indexed with the "cube configuration" and returns the edges needed to be joined together by a triangle.
// Edges returned are always in multiples of 3 (a triangle) and there are no cases where there are more than 5 triangles in a cube.
